...
#def cal_miou(test_dir="E:/skin/Test_Images",
#                pred_dir="E:/skin/results", gt_dir="E:/skin/Test_Labels"):
             #pred_dir="E:/skin/results", gt_dir="E:/skin/Test_Labels"):
def cal_miou(test_dir="C:/Users/Administrator/Desktop/unet/Test_Images",
    ...
    if miou_mode == 0 or miou_mode == 1:
        ...
        # 加载模型参数
        net.load_state_dict(torch.load('model.pth', map_location=device)) # todo
        # 测试模式
        net.eval()
